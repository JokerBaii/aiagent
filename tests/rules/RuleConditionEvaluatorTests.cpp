...
void runRuleConditionEvaluatorTests() {
    ...
    deployRule.condition =
        cc::JsonValue::Object{{"technical_route_completeness", true}};
    cc::CPIR software;
    ...
    const auto missingDeployment = cc::RuleConditionEvaluator{}.evaluate(
        deployRule, softwareInventory, software, {}, {}, {});
    requireTrue(missingDeployment.failed,
                "a build file must not be mistaken for a deployment guide");

    cc::AuditRule evidenceRule;
    evidenceRule.condition = cc::JsonValue::Object{
        {"required_claim_evidence", cc::JsonValue::Array{"CostReduction"}}};
    cc::ProjectClaim costClaim;
    costClaim.claimId = "CLM-COST";
    costClaim.claimType = cc::ClaimType::CostReduction;
    const auto missingCostEvidence = cc::RuleConditionEvaluator{}.evaluate(
        evidenceRule, {}, {}, {costClaim}, {}, {});
