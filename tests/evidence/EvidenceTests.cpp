...
void runEvidenceTests() {
    const cc::ProjectClaim marketClaim{"CLM-001", "市场规模预计达到 100 亿元",
                                       cc::ClaimType::MarketScale, "plan.md", 0.8, ""};
    cc::ProjectInventory marketInventory;
    marketInventory.assets.push_back(
        evidenceAsset("市场调研.md", cc::AssetRole::MarketResearch));
    ...
    const std::vector<cc::TextDocument> unrelated = {
        {"市场调研.md", "市场调研", "数据来源：行业年鉴，市场规模达到 200 亿元",
         "EXTRACTED_TEXT"}};
    const auto mismatched =
        cc::EvidenceMatcher{}.match({marketClaim}, marketInventory, unrelated);
    ...
    const std::vector<cc::TextDocument> supportedCorpus = {
        {"市场调研.md", "市场调研", "数据来源：行业年鉴，市场规模达到 100 亿元",
         "EXTRACTED_TEXT"}};
    ...
    requireTrue(graph.findByClaimId("CLM-001").has_value(),
                "evidence graph should find claim");
    ...
    const cc::ProjectClaim revenueClaim{"CLM-002", "已实现营收 50 万元",
                                        cc::ClaimType::Revenue, "plan.md", 0.8, ""};
    ...
    const cc::ProjectClaim patentClaim{"CLM-003", "已获得专利，专利号 12345678",
                                       cc::ClaimType::Patent, "plan.md", 0.8, ""};
    cc::ProjectInventory patentInventory;
    patentInventory.assets.push_back(
        evidenceAsset("专利说明.md", cc::AssetRole::PatentCopyright));
